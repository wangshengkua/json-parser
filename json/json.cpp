...
Json::operator bool(){
    if(m_type != json_bool){
        cout<<"type error, not bool value"<<endl;
    }
...
Json::operator int(){
    if(m_type != json_int){
        cout<<"type error, not int value"<<endl;
    }
...
Json::operator double(){
    if(m_type != json_double){
        cout<<"type error, not double value"<<endl;
    }
...
if(m_type != json_string){
    cout<<"type error, not string value"<<endl;
    }
